    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('admin/karyawan/pnlupdate');?>" role="form"> 
                        <input type="hidden" name="id_karyawan" value="<?php echo $this->uri->segment(4); ?>">
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="nama" value="<?php echo $dataDetail['namaPengguna'] ?>" placeholder="Isi Nama Karyawan" class="col-xs-10 col-sm-5" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="nilai" id="nilai" min="1" max="100" class="col-xs-10 col-sm-5" required>
                            </div>
                        </div>
