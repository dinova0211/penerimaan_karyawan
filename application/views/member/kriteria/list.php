                            ...
                            <tbody>
                                <?php $no=1; foreach($kriteria as $value){  ?>
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url('admin/kriteria/doDelete/'.$value['idKriteria']) ?>"><button class="btn btn-danger btn-sm"   style="margin-left:2px" onclick="return confirm('Anda yakin ingin menghapus data ini ? ')"><i class="fa fa-trash" style="font-size: 14px;"></i>&nbsp;&nbsp;<span>Hapus</span></button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
