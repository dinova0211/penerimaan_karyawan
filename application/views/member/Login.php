...
<html lang="en">
    <head>
        <link rel="icon" href="/assets/images/favicon.jpeg" type="image/jpg">
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Penerimaan Karyawan</span>
                                ...
                                <div id="forgot-box" class="forgot-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form method="post" action="<?php echo base_url('admin/login/forgetpassword') ?>" >
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                ...
                                <div id="signup-box" class="signup-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo base_url('admin/login/register_dosen'); ?>" method="POST">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="number" class="form-control" placeholder="NIP/NIDN" name="nip" required/>
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Repeat password" name="r_pass" required/>
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<b>Jenis Kelamin</b>
														<span class="block input-icon input-icon-right">
															<input type="radio" name="jeniskelamin" value="laki" checked> Laki-Laki
