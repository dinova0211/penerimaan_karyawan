    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row"> 
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengajuan/doUpdate/'.$this->uri->segment(4);?>" enctype="multipart/form-data" role="form"> 
                       <?php
                       ...
                       echo $this->session->flashdata('msgbox');?>
						...
						<div class="form-group"> 
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $userLogin['NIP']; ?>" name="NIP" readonly />
                            </div>
                        </div>
						<!--
                        <div class="form-group"> 
